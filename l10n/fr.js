OC.L10N.register(
    ...
    "An error occurred while uploading the icon, please make sure the data directory is writable" : "Une erreur est survenue lors de l'envoi de l'icône, merci de vérifier qu'il est possible d'écrire dans le dossier de destination",
    ...
    "Icon uploaded successfully" : "L'icône a été téléversée avec succès",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user's values to customize the links." : "Les balise {email}, {uid}, {displayname}, {groups}, {language} et {locale} peuvent être utilisées et sont remplies avec les données de l'utilisateur pour personnaliser les liens.",
    "When accessing the external site through the Nextcloud link, path parameters will be forwarded to the external site. So you can also create deep links (e.g. \"mycloud.com/external/1/pageA\" will lead to Nextcloud with the iframe pointed at \"externalsite.com/pageA\")." : "En accédant au site externe par un lien Nextcloud, les paramètres du chemin seront transmis au site externe. Vous pouvez donc également créer des liens permanents (par ex. \"mycloud.com/external/1/pageA\" va rediriger vers Nextcloud avec un iframe pointant sur \"externalsite.com/pageA\").",
    "Name" : "Nom",
    "URL" : "URL",
    "Configure site" : "Configurer le site",
    "Remove site" : "Retirer le site",
    ...
    "Failed to load admin config" : "Impossible de charger la config administrateur",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "Les éléments de substitution {email}, {uid}, {displayname}, {groups}, {language} et {locale} peuvent être utilisés et ont remplacés par les valeurs de l'utilisateur pour personnaliser les liens."
},
