OC.L10N.register(
    ...
    "Public footer" : "ئاممىۋى ئاستى قۇر",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "تىرناق {email}، {uid}، {displayname}، {groups}، {language} ھەمدە {locale} لەرنى ئىشلەتكىلى بولىدۇ ھەمدە ئىشلەتكۈچىنىڭ قىممەتلىرى ئارقىلىق ئۇلىنىشنى خاسلاشتۇرغاندا تولدۇرۇلدۇ",
