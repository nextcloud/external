OC.L10N.register(
    ...
    "Icons" : "Iconas",
    "If you upload a test.png and a test-dark.png file, both will be used as one icon. The dark version will be used on mobile devices, otherwise the white icon is not visible on the white background in the mobile apps." : "Se envía un ficheiro test.png e outro test-dark.png, ambos usaranse coma unha icona. A versión escura (dark) usarase en dispositivos móbeis, doutro xeito a icona branca non é visíbel no fondo branco das aplis móbeis.",
