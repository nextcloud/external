OC.L10N.register(
    ...
    "Add external sites to your Nextcloud navigation" : "Engade sitios externos á navegación do Nextcloud",
    ...
    "A JSON Web Token containing user´s email, uid and display name in its payload can be embedded into the link using the {jwt} placeholder. See the {linkstart}documentation{linkend} how to decode it." : "Pódese incrustar na ligazón un Token Web JSON que contén o correo electrónico, uid e nome de visualización do usuario na súa carga útil usando o marcador de posición {jwt}. Consulta na {linkstart}documentación{linkend} como descodificalo.",
    "Please note that some browsers will block displaying of sites via HTTP if you are running HTTPS." : "Teña en conta que algúns navegadores bloquearán a visualización de sitios a través de HTTP se está a executar HTTPS.",
    ...
    "Icons" : "Iconas",
    "If you upload a test.png and a test-dark.png file, both will be used as one icon. The dark version will be used on mobile devices, otherwise the white icon is not visible on the white background in the mobile apps." : "Se envía un ficheiro test.png e outro test-dark.png, ambos usaranse coma unha icona. A versión escura (dark) usarase en dispositivos móbiles, doutro xeito a icona branca non é visíbel no fondo branco dos aplis móbiles.",
