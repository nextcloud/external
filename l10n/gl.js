OC.L10N.register(
    ...
    "A JSON Web Token containing user´s email, uid and display name in its payload can be embedded into the link using the {jwt} placeholder. See the {linkstart}documentation{linkend} how to decode it." : "Pódese incrustar na ligazón un testemuño Web JSON que contén o correo electrónico, uid e nome para amosar do usuario na súa carga útil usando o marcador de posición {jwt}. Consulte na {linkstart}documentación{linkend} como descodificalo.",
