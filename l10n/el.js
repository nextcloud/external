OC.L10N.register(
    ...
    "External sites" : "Εξωτερικές τόποι",
    "__language_name__" : "Ελληνικά",
    "Add external sites to your Nextcloud navigation" : "Προσθέστε εξωτερικούς τόπους στην πλοήγησή του Nextcloud σας",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "Οι συμβολοσειρές {email}, {uid}, {displayname}, {groups}, {language} και {locale} μπορούν να χρησιμοποιηθούν και αντικαθίστανται με τις τιμές του χρήστη για την εξατομίκευση των συνδέσμων.",
    "When accessing the external site through the Nextcloud link, path parameters will be forwarded to the external site. So you can also create deep links (e.g. \"mycloud.com/external/1/pageA\" will lead to Nextcloud with the iframe pointed at \"externalsite.com/pageA\")." : "Κατά την πρόσβαση στον εξωτερικό ιστότοπο μέσω του συνδέσμου του Nextcloud, οι παράμετροι διαδρομής προωθούνται στον εξωτερικό ιστότοπο. Έτσι, μπορείτε επίσης να δημιουργήσετε βαθιούς συνδέσμους (π.χ. ο σύνδεσμος \"mycloud.com/external/1/pageA\" θα οδηγήσει στο Nextcloud με το iframe να δείχνει στο \"externalsite.com/pageA\").",
    "A JSON Web Token containing user´s email, uid and display name in its payload can be embedded into the link using the {jwt} placeholder. See the {linkstart}documentation{linkend} how to decode it." : "Ένα JSON διακριτικό δικτύου που περιέχει το email, το uid και το όνομα εμφάνισης του χρήστη στο payload του μπορεί να ενσωματωθεί στον σύνδεσμο χρησιμοποιώντας τη συμβολοσειρά {jwt}. Δείτε την {linkstart}τεκμηρίωση{linkend} για το πώς να το αποκωδικοποιήσετε.",
    ...
    "The placeholders {email}, {uid}, {displayname} and {groups} can be used and are filled with the user´s values to customize the links." : "Οι συμβολοσειρές {email}, {uid}, {displayname} και {groups} μπορούν να χρησιμοποιηθούν και αντικαθίστανται με τις τιμές του χρήστη για την εξατομίκευση των συνδέσμων."
},
