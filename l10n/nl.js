OC.L10N.register(
    ...
    "Add external sites to your Nextcloud navigation" : "Voeg externe sites toe aan je Nextcloud navigatie",
    ...
    "When accessing the external site through the Nextcloud link, path parameters will be forwarded to the external site. So you can also create deep links (e.g. \"mycloud.com/external/1/pageA\" will lead to Nextcloud with the iframe pointed at \"externalsite.com/pageA\")." : "Bij toegang tot de externe site via de Nextcloud-link worden padparameters doorgestuurd naar de externe site. Je kunt dus ook deep links maken (bv. \"mycloud.com/external/1/pageA\" zal naar Nextcloud leiden met het iframe gericht op \"externalsite.com/pageA\").",
