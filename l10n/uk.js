OC.L10N.register(
    ...
    "Reloading icon list…" : "Повторне отримання списку значків...",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "Заповнювачі {email}, {uid}, {displayname}, {groups}, {language} та {locale} можуть використовуватися і заповнюються значеннями користувача для налаштування посилань.",
