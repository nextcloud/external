OC.L10N.register(
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "Hægt er að nota frátökutáknin {email}, {uid}, {displayname}, {groups}, {language} og {locale} og eru þau fyllt með upplýsingum um notandann til að sérsníða veftenglana.",
    ...
    "The placeholders {email}, {uid}, {displayname} and {groups} can be used and are filled with the user´s values to customize the links." : "Hægt er að nota frátökutáknin {email}, {uid}, {displayname} og {groups} og eru þau fyllt með upplýsingum um notandann til að sérsníða veftenglana."
},
