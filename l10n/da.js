OC.L10N.register(
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "Pladsholderne {email}, {uid}, {displayname}, {groups}, {language} og {locale} kan bruges og udfyldes med brugerens værdier for at tilpasse linkene.",
