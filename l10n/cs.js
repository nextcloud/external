OC.L10N.register(
    ...
    "Name" : "Název",
    "URL" : "URL",
    "Configure site" : "Nastavit stránky",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "Je možné použít zástupná vyjádření {email}, {uid}, {displayname}, {groups}, {language} a {locale} jsou vyplněné hodnotami uživatele pro přizpůsobení odkazů."
},
