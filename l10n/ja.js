OC.L10N.register(
    ...
    "The placeholders {email}, {uid} and {displayname} can be used and are filled with the user´s values to customize the links." : "プレースホルダ {email},、{uid}および{displayname} を使用でき、リンクをカスタマイズするためのユーザの値が入力されます。",
