OC.L10N.register(
    ...
    "Only in the desktop client" : "Yalnızca bilgisayar uygulamasında",
    ...
    "Redirect" : "Yönlendir",
    "Failed to load admin config" : "Yönetici yapılandırması yüklenemedi",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "{email}, {uid}, {displayname}, {groups}, {language} ve {locale} kodları bağlantıları özelleştirmek için kullanıcının değerleri ile doldurulur."
},
