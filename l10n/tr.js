OC.L10N.register(
    ...
    "Icons" : "Simgeler",
    "If you upload a test.png and a test-dark.png file, both will be used as one icon. The dark version will be used on mobile devices, otherwise the white icon is not visible on the white background in the mobile apps." : "test.png ya da test-dark.png adında iki dosya yüklerseniz, ikisi dosya tek simge olarak kullanılır. Mobil uygulamalarda beyaz simge beyaz art alan üzerinde görülemeyeceğinden mobil aygıtlarda koyu sürüm kullanılır.",
