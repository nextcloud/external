OC.L10N.register(
    ...
    "Only in the Android app" : "Csak az androidos alkalmazásban",
    "Only in the iOS app" : "Csak az iOS-es alkalmazásban",
    ...
    "New site" : "Új oldal",
    "Uploading…" : "Feltöltés…",
    "Icon uploaded successfully" : "Az ikon sikeresen feltöltve",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user's values to customize the links." : "Az {email}, {uid}, {displayname}, {groups}, {language} és {locale} helykitöltők használhatók, és behelyettesítésre kerülnek a megfelelő felhasználói adatokkal, hogy személyre szabják a hivatkozásokat.",
    "When accessing the external site through the Nextcloud link, path parameters will be forwarded to the external site. So you can also create deep links (e.g. \"mycloud.com/external/1/pageA\" will lead to Nextcloud with the iframe pointed at \"externalsite.com/pageA\")." : "Ha a külső oldalt egy nextcloudos hivatkozással éri el, akkor az útvonal-paraméterek továbbítva lesznek a külső oldal felé. Így mély hivatkozásokat is létrehozhat (például a „mycloud.com/external/1/pageA” egy olyan Nextcloud-oldalra vezet, ahol az iframe erre a címre mutat: „externalsite.com/pageA”).",
    "Name" : "Név",
    "URL" : "URL",
    "Configure site" : "Oldal beállítása",
    ...
    "Failed to load admin config" : "Nem sikerült az adminisztrációs konfiguráció betöltése",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "Az {email}, {uid} és {displayname}, {groups}, {language} és {locale} helykitöltők használhatóak, és behelyettesítésre kerülnek a megfelelő felhasználói adatokkal, hogy személyre szabják a hivatkozásokat."
},
