OC.L10N.register(
    ...
    "When accessing the external site through the Nextcloud link, path parameters will be forwarded to the external site. So you can also create deep links (e.g. 'mycloud.com/external/1/pageA' will lead to Nextcloud with the iframe pointed at 'externalsite.com/pageA')." : "Podczas uzyskiwania dostępu do witryny zewnętrznej za pośrednictwem linku Nextcloud, parametry ścieżki zostaną przekazane do witryny zewnętrznej. Możesz więc także tworzyć głębokie linki (np. 'mycloud.com/external/1/pageA' będzie prowadzić do Nextcloud z ramką iframe wskazywaną na 'externalsite.com/pageA')."
},
