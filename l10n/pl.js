OC.L10N.register(
    ...
    "Uploading…" : "Wysyłanie…",
    "Icon uploaded successfully" : "Ikona została pomyślnie przesłana",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user's values to customize the links." : "Symbole zastępcze {email}, {uid}, {displayname}, {groups}, {language} i {locale}mogą być używane i zostaną uzupełnione wartościami użytkownika w celu dostosowania linków",
    "When accessing the external site through the Nextcloud link, path parameters will be forwarded to the external site. So you can also create deep links (e.g. \"mycloud.com/external/1/pageA\" will lead to Nextcloud with the iframe pointed at \"externalsite.com/pageA\")." : "Po uzyskaniu dostępu do witryny zewnętrznej za pośrednictwem linku Nextcloud parametry ścieżki zostaną przekazane do witryny zewnętrznej. Możesz więc również tworzyć głębokie linki (np. \"mojachmura.pl/zewnętrzny/1/stronaA\" będzie prowadzić do Nextcloud z ramką iframe skierowaną na \"zewnetrznastrona.pl/stronaA\").",
    "Name" : "Nazwa",
    "URL" : "URL",
    "Configure site" : "Skonfiguruj witrynę",
    ...
    "Redirect" : "Przekieruj",
    "Failed to load admin config" : "Nie udało się wczytać konfiguracji administratora",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "Można użyć symboli zastępczych {email}, {uid}, {displayname}, {groups}, {language} i {locale} wypełniając je wartościami użytkownika w celu dostosowania linków."
},
