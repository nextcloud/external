OC.L10N.register(
    ...
    "Icon uploaded successfully" : "Ikona bola úspešne nahraná",
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user's values to customize the links." : "Na prispôsobenie odkazov možno použiť zástupné symboly {email}, {uid}, {displayname}, {groups}, {language} a {locale}, ktoré sa vyplnia hodnotami používateľa.",
    ...
    "Name" : "Názov",
    "URL" : "URL",
    "Configure site" : "Konfigurovať stránku",
    ...
    "Failed to load admin config" : "Nepodarilo sa načítať konfiguráciu správcu",
