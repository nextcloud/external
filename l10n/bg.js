OC.L10N.register(
    ...
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user´s values to customize the links." : "Полетата за {email},{uid},{displayname},{groups},{language} и {locale}могат да се използват и се попълват със стойностите, които искате да зададете за съответните връзки.",
