OC.L10N.register(
    ...
    "The placeholders {email}, {uid} and {displayname} can be used and are filled with the user´s values to customize the links." : "{email}, {uid} eta {displayname} posizio-markatzaileak erabil daitezke eta erabiltzailearen balioekin osatzen dira bere estekak pertsonalizatzeko.",
    "When accessing the external site through the Nextcloud link, path parameters will be forwarded to the external site. So you can also create deep links (e.g. 'mycloud.com/external/1/pageA' will lead to Nextcloud with the iframe pointed at 'externalsite.com/pageA')." : "Kanpoko gunera Nextcloud estekaren bidez sartzean, bide-parametroak kanpoko gunera bidaliko dira. Beraz, esteka sakonak ere sor ditzakezu (adib. 'mycloud.com/external/1/pageA'  Nextcloud-era bidaliko zaitu iframe-a 'externalsite.com/pageA' seinalatuta)."
},
