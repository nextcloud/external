OC.L10N.register(
    ...
    "User quota" : "Vartotojui leidžiamas duomenų kiekis",
    ...
    "This application allows an admin to add additional links into the Nextcloud menus.\nFollowing a link, the external website appears in the Nextcloud frame.\nIt is also possible to add links only for a given language, device type or user group.\n\nMore information is available in the External sites documentation." : "Ši programėlė leidžia administratoriams  pridėti papildomas nuorodas prie Nextcloud parinkčių.\n Sekant nuorodą, išorinė svetainė pasirodo „Nextcloud“ rėmelyje.\nTaip pat galima pridėti nuorodas priklausomai nuo tik tam tikros kalba, įrenginio tipo ar vartotojų grupės.",
    "A JSON Web Token containing user´s email, uid and display name in its payload can be embedded into the link using the {jwt} placeholder. See the {linkstart}documentation{linkend} how to decode it." : "JSON interneto žymuo, susidedantis iš vartotojo el. pašto, UID ir rodomo vardo, gali būti įterptas į nuorodą naudojant {jwt} skirtuką. Daugiau informacijos, kaip iššifruoti {linkstart}dokumentacijoje{linkend}",
    "New site" : "Nauja svetainė",
    "Uploading…" : "Įkeliama…",
    "Icon uploaded successfully" : "Piktograma sėkmingai įkelta",
    "Icon could not be uploaded" : "Nepavyko įkelti piktogramos",
    "Add a website directly to the app list in the top bar. This will be visible for all users and is useful to quickly reach other internally used web apps or important sites." : "Pridėti svetainę į įskiepių sąrašą viršuje. Svetainę galės naudoti visi vartotojai ir nuoroda bus naudinga, kai reiks pasiekti tam tikras internetines svetaines ar portalus.",
    "The placeholders {email}, {uid}, {displayname}, {groups}, {language} and {locale} can be used and are filled with the user's values to customize the links." : "Vietos rezervavimo ženklai {email}, {uid}, {displayname}, {groups},  {language} ir {locale} gali būti naudojami ir užpildomi vartotojo reikšmėmis nuorodoms tinkinti.",
    "When accessing the external site through the Nextcloud link, path parameters will be forwarded to the external site. So you can also create deep links (e.g. \"mycloud.com/external/1/pageA\" will lead to Nextcloud with the iframe pointed at \"externalsite.com/pageA\")." : "Kai prisijungiama prie išorinės svetainės per „Nextcloud“ nuorodą, kelio parametrai bus peradresuoti į išorinę svetainę. Taigi, taip pat galite kurti giliąsias nuorodas (pvz., „mycloud.com/external/1/pageA“ nukreips į „Nextcloud“, o „iframe“ bus nukreiptas į „externalsite.com/pageA“).",
    "Name" : "Pavadinimas",
    "URL" : "URL",
    "Configure site" : "Konfigūruoti svetainę",
    ...
    "Redirect" : "Nukreipti",
    "Failed to load admin config" : "Nepavyko įkelti administratoriaus konfigūracijos",
