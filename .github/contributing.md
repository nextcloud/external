...
* This repository ([External sites](https://github.com/nextcloud/external/issues)) is *only* for issues within the External sites code.
...
[template]: https://raw.github.com/nextcloud/external/master/.github/issue_template.md
