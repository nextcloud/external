...
<div id="external">
	<div class="section">
		...
		<p class="settings-hint"><?php p($l->t('The placeholders {email}, {uid}, {displayname}, {groups} and {language} can be used and are filled with the user´s values to customize the links.')); ?></p>
