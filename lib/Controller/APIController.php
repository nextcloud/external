...
class APIController extends OCSController {
	 ...
	 * @return DataResponse
	 */
	public function add($name, $url, $password, $lang, $type, $device, $icon, array $groups, $redirect) {
		try {
			return new DataResponse($this->sitesManager->addSite($name, $url, $password, $lang, $type, $device, $icon, $groups, (bool) $redirect));
	 ...
	 * @return DataResponse
	 */
	public function update($id, $name, $url, $password, $lang, $type, $device, $icon, array $groups, $redirect) {
		try {
			return new DataResponse($this->sitesManager->updateSite($id, $name, $url, $password, $lang, $type, $device, $icon, $groups, (bool) $redirect));
